...
module.exports = {
    ...
    run: async (Discord, client, interaction, sender, guild) => {
        ...
        const embed = new Discord.MessageEmbed()
            ...
            .addField(`🔊 **• __En vocal:__**`, `${(voiceChannel ? voiceChannel : `Non ❌`)}`, true)
            .addField(`📅 **• __Compte créer le:__**`, `\`${createdAt}\``, true)
            .addField(`📡 **• __Rejoint le:__**`, `\`${joinedAt}\``, true)
            .addField(`🔇 **• __Est muet depuis:__**`, `\`${mutedAt == `Invalide date` ? mutedAt : `Non ❌`}\``, true)
            .addField(`💰 **• __Est premium depuis:__**`, `\`${premiumSince == `Invalide date` ? premiumSince : `Non ❌`}\``, true)
